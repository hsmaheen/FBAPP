...
{
     public boolean sendEmail_gmail(String sendto_name,String sendto_email,String sendto_content) {
        boolean status = false;
        
            String host = "smtp.gmail.com";
            String userName = "hsmaheen@gmail.com";
            String userMail = "hsmaheen@gmail.com";
            String authorization = "true";
            String port = "465";
            String socketFactoryClass = "javax.net.ssl.SSLSocketFactory";
            String socketFactoryPort = "465";
            String password = "MacosX16";
        ...
        try {
            ...
            message.setSubject("FRESH FOODS : Order Confirmation");
            try {
